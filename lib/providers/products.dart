...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProduct() async {
    ...
    try {
      ...
      url = Uri.parse(('https://shop-app-d00fc-default-rtdb.firebaseio.com/userFavourites/$userId.json?auth=$authToken'));
      ...
      extractedData.forEach((prodId, prodData) {
        loadedProducts.add(Product(
            ...
            isFavourite: favoriteData == null? false : favoriteData[prodId] ?? null,
